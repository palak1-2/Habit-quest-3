...
2. **Clone the Repository:**
   ```bash
   git clone [https://github.com/palak1-2/habitquest.git](https://github.com/palak1-2/habitquest.git)
   cd habitquest
Run the Server: Open your terminal in the project folder and run:
...
Monitor Growth: Watch your XP bar fill up and check your category stats in the sidebar.
